    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>History Fan Control</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div>
                    <div class="breadcrumb-item">History Fan</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Data Riwayat Kipas Menyala</h2>
                <p class="section-lead">
                    Berikut data rekapitulasi dari nyalanya kipas
                </p>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <form class="form-inline ml-auto" action="{{ route('dashboard.history.fan') }}">
                                        <!-- Input Pencarian -->
                                        ...
                                        <tbody>
                                            @foreach ($histories as $history)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('dashboard.history.fan.delete', $history->id) }}"
